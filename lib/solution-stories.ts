...
export const solutionStories = {
    ...
    oem: {
        ...
        situationTitle: 'Nicht die erste Nummer zählt, sondern die belegbare Zuordnung.',
        situationIntro: 'Fahrzeug, Baugruppe, Katalogtreffer und offene Ausstattungsmerkmale müssen gemeinsam betrachtet werden. Genau diese Prüfkette macht Partsunion sichtbar.',
        situations: [
            { moment: 'Fahrzeug', title: 'Die richtige Ausführung bestimmen.', text: 'VIN, HSN/TSN oder Fahrzeugschein liefern den Ausgangspunkt für die weitere Suche.' },
            { moment: 'Katalog', title: 'Das Bauteil im Herstellerkontext eingrenzen.', text: 'Lizenzierte Herstellerkataloge führen zur OE-Referenz; unklare Varianten bleiben ausdrücklich offen.' },
            { moment: 'Artikel', title: 'Passende Ware wirtschaftlich auswählen.', text: 'OE-Bezug, Alternativen, eigener Bestand und Preis stehen für die Fachentscheidung nebeneinander.' },
        ],
        comparisonTitle: 'Weniger Fensterspringen. Mehr nachvollziehbare Teileentscheidung.',
        workflowTitle: 'Die Prüfkette vom Fahrzeug bis zum Artikel.',
        ...
        outcomes: [
            ...
            { title: 'Sichtbare Restfragen', text: 'Ausstattung oder Ausführung werden nicht still angenommen, wenn die Datenlage offen ist.' },
            { title: 'Verkaufsfertiges Ergebnis', text: 'Der passende Artikel kann mit Verfügbarkeit und Kondition direkt weiterverarbeitet werden.' },
        ],
    },
    order: {
        situationEyebrow: 'Ein Vorgang bis zum Zahlungseingang',
        situationTitle: 'Die Kundenfreigabe startet keine neue Datenerfassung.',
        situationIntro: 'Was in Anfrage und Teileprüfung bereits geklärt wurde, bleibt im Angebot, Auftrag und jedem folgenden Beleg erhalten.',
        situations: [
            { moment: 'Angebot', title: 'Geprüfte Teile werden kalkuliert.', text: 'Menge, EK, VK, Marge, Lieferhinweis und Fahrzeugkontext stehen gemeinsam am Angebot.' },
            { moment: 'Auftrag', title: 'Die Zusage wird sauber weitergeführt.', text: 'Bestand, Reservierung und Fehlmenge werden je Position sichtbar, ohne die Auswahl neu aufzubauen.' },
            { moment: 'Abschluss', title: 'Lieferung, Rechnung und Zahlung schließen die Kette.', text: 'Jeder Beleg zeigt auf denselben Ursprung und den aktuellen Stand des Geschäfts.' },
        ],
        comparisonTitle: 'Eine Belegkette statt mehrerer Einzelarbeiten.',
        workflowTitle: 'So bleibt ein Verkauf vom ersten Ja bis zur Zahlung zusammen.',
        capabilityTitle: 'Was Partsunion im Verkaufsprozess miteinander verbindet.',
        outcomeTitle: 'Der Auftrag bleibt steuerbar, auch wenn nicht alles sofort lieferbar ist.',
        outcomes: [
            { title: 'Positionen im Blick', text: 'Lieferbar, reserviert, im Zulauf oder fehlend wird direkt am Auftrag unterschieden.' },
            { title: 'Konditionen im Blick', text: 'Preis, Steuer, Marge und Kundenvereinbarung bleiben an der jeweiligen Position.' },
            { title: 'Belege im Blick', text: 'Angebot, Auftrag, Lieferschein, Rechnung und Zahlung bilden eine nachvollziehbare Kette.' },
        ],
    },
    procurement: {
