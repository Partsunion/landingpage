...
export const generatedArticles: GeneratedArticle[] = [
    {
        "meta": {
            ...
            "description": "Welche WaWi passt zum Kfz-Teilehandel? Checkliste zu OEM/Fitment, ATP, Foto-Wareneingang, Inventur, Altteilpfand und GoBD.",
            "excerpt": "Eine praxisnahe Auswahl-Checkliste, mit der Autoteilehändler ein Warenwirtschaftssystem finden, das OEM-Bezug, Fitment, Bestandsführung und GoBD-Pflichten wirklich abdeckt.",
            "category": "Ratgeber",
            "readingMinutes": 7,
            "keywords": [
        ...
        "blocks": [
            {
                "type": "p",
                "text": "Eine Warenwirtschaft für den Autoteilehandel ist kein reines Buchhaltungs-Werkzeug, sondern das Rückgrat des Tagesgeschäfts: Welcher Artikel passt an welches Fahrzeug, ist er wirklich verfügbar, was hat er gekostet und wie wird er korrekt fakturiert? Viele generische Systeme beantworten diese Fragen nur halb, weil sie nie für Kfz-Teile gebaut wurden. Diese Checkliste zeigt Schritt für Schritt, worauf Sie bei der Auswahl achten sollten – von der OEM-Ermittlung über die Lagerverwaltung für Autoteile bis zur GoBD-Anbindung. Ziel ist, dass Sie ein Warenwirtschaftssystem auswählen, das zu den Eigenheiten des Teilehandels passt und nicht dagegen arbeitet."
            },
            {
                "type": "h2",
        ...
        "faqs": [
            ...
            },
            {
                ...
                "a": "ATP steht für Available to Promise, also den frei verkäuflichen Bestand. Reservierte oder bereits zugesagte Mengen werden vom physischen Lagerbestand abgezogen, sodass nicht zweimal dieselbe Position verkauft wird. Gerade bei Einzelstücken und Gebrauchtteilen verhindert das ATP-Prinzip Doppelverkäufe und damit Retouren und Margenverlust."
            },
            {
    ...
    },
    {
        "meta": {
            ...
            "description": "ERP-Vergleich für Autoteile: Warum generische Systeme im Teilehandel oft Customizing brauchen und was eine branchenspezifische Lösung besser löst — OEM, WhatsApp, DACH-Steuer.",
            "excerpt": "Generisches ERP anpassen oder branchenspezifisch starten? Der ehrliche Vergleich für den Autoteilehandel — von OEM-Logik über WhatsApp bis DACH-Steuer und Einführungszeit.",
            "category": "Ratgeber",
            "readingMinutes": 10,
            "keywords": [
                "ERP Autoteilehandel",
        ...
        "blocks": [
            ...
            {
                "type": "p",
                "text": "Am Beispiel von Partsunion lässt sich zeigen, was ein für den Autoteilehandel gebautes System ab Werk mitbringt, ohne dass es nachgerüstet werden muss. Die folgenden Funktionen sind live; ausdrücklich noch in Entwicklung und damit nicht als verfügbar zu verstehen sind Marktplatz- und Shop-Sync (z. B. eBay), Großhändler-Direktbestellung, Vorkasse per Chat (Stripe/PayPal) und Versand-Tracking."
            },
            {
                "type": "ul",
                "items": [
    ...
    },
    {
        "meta": {
            ...
            "description": "GoBD, TSE (§146a AO), DSFinV-K, ZUGFeRD/XRechnung und DATEV im Teilehandel: Was an der Theke Pflicht ist und wie Partsunion es abdeckt.",
            "excerpt": "Der kompakte Compliance-Leitfaden zu GoBD, TSE, DSFinV-K, E-Rechnung und DATEV für den Autoteilehandel – sachlich, branchengerecht und ohne Fachchinesisch.",
            "category": "Compliance",
            "readingMinutes": 8,
            "keywords": [
        ...
        "blocks": [
            ...
            {
                "type": "p",
                "text": "Partsunion ist auf §146a AO, die GoBD und den DSFinV-K-Standard ausgelegt und liefert die geforderten Exporte und Festschreibungsmechanismen. Wichtig zur Einordnung: Die TSE selbst ist eine zertifizierte Komponente (Cloud- oder Hardware-TSE), deren konkrete Einrichtung von Ihrem Kassen-Setup abhängt. Klären Sie die TSE-Anbindung für Ihren Theken-Hardwarestand im Beratungsgespräch ab, damit das Zusammenspiel sauber zertifiziert läuft."
            },
            {
                "type": "h2",
            ...
            {
                "type": "p",
                "text": "Die DSFinV-K (Digitale Schnittstelle der Finanzverwaltung für Kassensysteme) ist das standardisierte Format, in dem Kassendaten bei einer Kassen-Nachschau oder Betriebsprüfung herausgegeben werden müssen. Der Prüfer erscheint heute mit einem USB-Stick und erwartet einen strukturierten, maschinenlesbaren Export aller Einzelvorgänge – nicht eine PDF-Zusammenfassung. Ein sauberes Kassenbuch im Autohandel allein genügt nicht mehr, wenn die DSFinV-K-Daten nicht exportierbar sind."
            },
            {
                "type": "p",
                "text": "Partsunion erzeugt den DSFinV-K-Export, sodass Einzelaufzeichnungen, Stammdaten und Kassenabschlüsse im geforderten Schema bereitstehen. Das nimmt der Kassen-Nachschau ihren Schrecken: Statt im Prüfungsfall Daten manuell zusammenzusuchen, geben Sie den standardisierten Export ab. In Kombination mit der Festschreibung und dem Audit-Log entsteht eine durchgängig nachvollziehbare Kette vom Verkauf bis zur Auswertung – über die mehr als 40 datengetriebenen Auswertungen lassen sich Umsätze, Steuersätze und Kassenbewegungen jederzeit nachvollziehen."
            },
            {
                "type": "h2",
            ...
            },
            {
                ...
                "links": [
                    {
                        "label": "GoBD, TSE, DSFinV-K, ZUGFeRD und DATEV im Detail – die Compliance-Funktionen von Partsunion",
                        "href": "/features/gobd-tse-zugferd-datev"
                    },
                    {
    ...
    },
    {
        "meta": {
            ...
            "description": "KI-Foto-Wareneingang und Retoure per Foto im Teilelager: Abgleich mit Bestellung, Reklamation aus Foto, weniger Phantombestand, ehrliche ATP-Verfügbarkeit.",
            "excerpt": "Wie KI-gestützter Foto-Wareneingang und Retoure per Foto die Erfassung im Autoteilelager beschleunigen, Phantombestand reduzieren und die ATP-Verfügbarkeit ehrlich halten.",
            "category": "Ratgeber",
            "readingMinutes": 7,
            "keywords": [
                "Foto-Wareneingang",
    ...
    },
    {
        "meta": {
            ...
            "description": "Leitfaden zum Aufbau eines White-Label B2B-Kundenportals für Autoteile: kundenspezifische Preise ohne Preis-Leck, Self-Service-Rechnungen, eigene Domain.",
            "excerpt": "Wie Sie ein White-Label-B2B-Kundenportal aufbauen, das Werkstatt-Stammkunden bindet, mit serverseitigen Preisen, Self-Service-Belegen und einer ehrlichen Verbindlichkeitsgrenze.",
            "category": "Ratgeber",
            "readingMinutes": 7,
            "keywords": [
    ...
    },
    {
        "meta": {
            ...
            "description": "E-Rechnungspflicht 2025 im B2B: Empfangspflicht, Übergangsfristen bis 2028, ZUGFeRD vs. XRechnung und was Autoteilehändler jetzt vorbereiten sollten.",
            "excerpt": "Was die B2B-E-Rechnungspflicht seit 2025 bedeutet, welche Fristen bis 2028 gelten und wie ZUGFeRD und XRechnung den Autoteilehandel betreffen.",
            "category": "Compliance",
            "readingMinutes": 7,
            "keywords": [
        ...
        "blocks": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    "Bis 31.12.2026: Papier- und sonstige Rechnungen (etwa PDF) dürfen mit Zustimmung des Empfängers weiter ausgestellt werden.",
            ...
            {
                "type": "p",
                "text": "Partsunion ist als branchenspezifische Plattform für den Autoteilehandel gebaut und erzeugt Rechnungen wahlweise als ZUGFeRD (hybrides PDF mit eingebettetem XML) oder als XRechnung nach EN 16931. Die Differenzbesteuerung läuft als durchgängiger Pfad: Artikel-Flag, Theke-Badge, automatische Margenberechnung, ZUGFeRD-Codierung und Pflichthinweis auf dem PDF. Exporte für DATEV (SKR03/04, EXTF) sind ebenso vorhanden wie Funktionen rund um GoBD, TSE nach Paragraf 146a und DSFinV-K."
            },
            {
                "type": "h2",
    ...
    },
    {
        "meta": {
            ...
            "description": "Differenzbesteuerung §25a für Gebrauchtteile: Wann anwendbar, Margenbesteuerung, kein offener USt-Ausweis, Pflichthinweis und Abgrenzung zur Regelbesteuerung.",
            "excerpt": "Wann die Differenzbesteuerung nach §25a UStG für Gebrauchtteile gilt, wie die Margenbesteuerung funktioniert und was beim USt-Ausweis und Pflichthinweis auf der Rechnung zu beachten ist.",
            "category": "Compliance",
            "readingMinutes": 7,
            "keywords": [
