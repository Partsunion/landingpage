...
export const solutionPages: SolutionPageData[] = [
    {
        ...
        capabilities: [
            ...
            { title: 'Übergabe ohne Medienbruch', text: 'Die geprüfte Anfrage kann in Angebot, Auftrag, Retoure oder Reklamation weitergeführt werden.' },
        ],
    ...
    },
    {
        ...
        intro: 'Kunde, Fahrzeug, Teileauswahl, Preis und Verfügbarkeit gehen direkt ins Dashboard. Partsunion erstellt das Angebot, führt den Kunden über WhatsApp zur Zahlung und übernimmt Auftrag und Rechnung ohne erneute Dateneingabe.',
        promise: 'Einmal geklärt. Danach automatisch bis zum Abschluss.',
        screenshot: '/product/verkaufsauftrag.png', screenshotAlt: 'Aktueller Partsunion Verkaufsauftrag mit Fehlmengen und Belegfluss',
        without: ['Angebot aus Chat und Katalog neu tippen', 'Kundenzusage manuell in einen Auftrag übertragen', 'Zahlungsstatus aus Nachrichten zusammensuchen', 'Rechnung nachträglich aus dem Auftrag bauen'],
        withPartsunion: ['Alle Anfragedaten direkt im Dashboard', 'Angebot automatisch erstellen und per WhatsApp senden', 'Sichere Zahlung direkt aus dem Chat starten', 'Auftrag und Rechnung automatisch weiterführen'],
        workflow: [
            { number: '01', title: 'Anfrage übernehmen', text: 'Kunde, Fahrzeug, geprüfte Teile, Preis und Verfügbarkeit gehen vollständig weiter.' },
            { number: '02', title: 'Angebot senden', text: 'Das Angebot wird automatisch erstellt und im WhatsApp-Gespräch bereitgestellt.' },
            { number: '03', title: 'Auftrag und Zahlung verbinden', text: 'Die Kundenzusage legt den Auftrag an; der Kunde startet die sichere Zahlung über den Link im Chat.' },
            { number: '04', title: 'Rechnung abschließen', text: 'Der Zahlungsstatus landet am Auftrag; die Rechnung folgt dem festgelegten Auslöser.' },
        ],
        capabilities: [
            { title: 'Vollständige Datenübergabe', text: 'Kunde, Fahrzeug, Teilebedarf, OE-Bezug, Preis und Verfügbarkeit stehen direkt im Dashboard.' },
            { title: 'WhatsApp-Checkout', text: 'Angebot, Zahlungsart und sicherer Zahlungslink bleiben im laufenden Kundengespräch.' },
            { title: 'Automatische Belegkette', text: 'Anfrage, Angebot, Auftrag, Rechnung und Zahlung bleiben verbunden und werden anhand festgelegter Auslöser weitergeführt.' },
            { title: 'Ausnahmen statt Handarbeit', text: 'Eindeutige Vorgänge laufen durch; nur unklare oder freigabepflichtige Fälle kommen in die Bearbeitung.' },
        ],
        controlTitle: 'Der Standardfall läuft automatisch. Ausnahmen bleiben kontrolliert.', controlText: 'Sind Daten, Preis, Verfügbarkeit und Zahlung eindeutig und die Regeln des Betriebs erfüllt, läuft der Verkauf ohne manuelles Eingreifen. Niedrige Margen, abweichende Zahlungen, unklare Kundenzusagen oder fehlende Pflichtangaben stoppen den Ablauf gezielt und legen den vollständigen Vorgang zur Prüfung vor.',
    ...
    },
    {
        ...
        intro: 'Partsunion führt Mengenartikel und konkrete Einzelstücke in einer gemeinsamen Warenwirtschaft. Bestand, Reservierung, Lagerort, Einkauf, Verkauf, Retoure und Reklamation bleiben nachvollziehbar.',
    ...
    {
        slug: 'retouren', navLabel: 'Retouren & Reklamationen', group: 'Ware bewegen', icon: 'returns', visual: 'returns',
        eyebrow: 'Rückgaben und Mängel sauber bearbeiten',
        title: 'Retoure oder Reklamation in einem Zug statt mühseliger Kleinarbeit.',
        intro: 'Artikelnummer abfotografieren, Ursprungsbeleg finden und den Fall klar einordnen: normale Rückgabe, defektes Teil, Falschlieferung oder Lieferantenreklamation. Grund, Zustand, Fotos, Verantwortung und Bearbeitungsstand bleiben am selben Vorgang.',
        promise: 'Weniger Tipparbeit. Vollständiger Kontext. Klare Entscheidung.',
        without: ['Rückgabe und Reklamation auf Zetteln vermischen', 'Artikel und Ursprungsbeleg zusammensuchen', 'Fotos unverbunden auf dem Handy', 'Bestand oder Gutschrift zu früh verändern'],
        withPartsunion: ['Retoure oder Reklamation direkt am Teil erfassen', 'Ursprungsbeleg und Verantwortlichkeit zuordnen', 'Optionale Zustandsfotos am Vorgang', 'Kunden- und Lieferantenfall mit eigenem Status bearbeiten'],
        workflow: [
            { number: '01', title: 'Artikel erfassen', text: 'Nummer scannen oder fotografieren; Teil und Beleg werden gesucht.' },
            { number: '02', title: 'Ursprung verbinden', text: 'Verkauf, Auftrag oder Wareneingang werden dem Teil eindeutig zugeordnet.' },
            { number: '03', title: 'Fall einordnen', text: 'Rückgabe, Defekt, Falschlieferung und Verantwortlichkeit werden unterschieden.' },
            { number: '04', title: 'Folgen bearbeiten', text: 'Erst nach Prüfung folgen Bestand, Gutschrift, Erstattung oder Lieferantenreklamation.' },
        ],
        capabilities: [
            { title: 'Kundenretoure', text: 'Rückgabegrund, Verkaufsposition, Menge und ursprüngliche Kondition bleiben am Fall.' },
            { title: 'Kundenreklamation', text: 'Defekte oder falsche Teile können mit Beschreibung und optionalen Fotos gemeldet werden.' },
            { title: 'Lieferantenreklamation', text: 'Fehlmenge, Übermenge, Falschteil oder Beschädigung erhalten einen eigenen Bearbeitungsstand.' },
            { title: 'Getrennte Auswirkungen', text: 'Bestand, Gutschrift, Erstattung und Reklamationsstatus werden nicht still gekoppelt.' },
        ],
        controlTitle: 'Erfassen ist noch keine Gutschrift.', controlText: 'Eine Retoure oder Reklamation verändert weder automatisch den Bestand noch erzeugt sie still eine Gutschrift. Erst die fachliche Entscheidung löst Wiedereinlagerung, Erstattung oder die weitere Bearbeitung beim Lieferanten aus.',
    ...
    },
    {
        ...
        intro: 'Frag nach Produkten, Bestand, Aufträgen, Retouren, Reklamationen, Umsatz, Forderungen oder offenen Aufgaben. Der Betriebsassistent verbindet freigegebenes Betriebswissen mit dem aktuellen Vorgang, erklärt die Lage und kann die nächste Bearbeitung direkt vorbereiten.',
    ...
    },
    {
        ...
        intro: 'Die Partsunion Händler-App bringt Erfassung dorthin, wo das Teil liegt. Artikelnummern, Fotos, Fahrzeuge, Retouren und Reklamationen werden mobil aufgenommen und stehen anschließend direkt im passenden Vorgang der Warenwirtschaft.',
        ...
        withPartsunion: ['Kamera für Artikelnummer und Dokument', 'Vorgang direkt Kunde, Auftrag, Retoure oder Reklamation zuordnen', 'Optionale Fotos am richtigen Datensatz', 'Im Desktop auf demselben Stand weiterarbeiten'],
        workflow: [
        ...
        capabilities: [
            ...
            { title: 'Retoure oder Reklamation dokumentieren', text: 'Fallart, Grund, Zustand, Beleg und optionale Fotos ergeben einen prüfbaren Entwurf.' },
