...
export const solutionPages: SolutionPageData[] = [
    {
        ...
        eyebrow: 'WhatsApp, Telefon, Theke und E-Mail',
        title: 'Jede Teileanfrage startet als bearbeitbarer Vorgang.',
        intro: 'Kunden schreiben frei, schicken ein Foto oder rufen an. Partsunion bringt Nachricht, Kunde, Fahrzeug und Teilebedarf in eine gemeinsame Anfrage-Inbox – ohne dass der Kontext zwischen Handy, Zettel und Warenwirtschaft verloren geht.',
        ...
        without: ['Chat auf einem separaten Handy', 'Fahrzeugdaten in Notizen oder im Kopf', 'Rückfragen ohne sichtbaren Bearbeitungsstand', 'Angebot später erneut aus dem Chat abtippen'],
        withPartsunion: ['Alle Kanäle in einer Anfrage-Inbox', 'Originalnachricht und Dokument bleiben erhalten', 'Kunde, Fahrzeug und Teil werden verbunden', 'Angebot entsteht direkt aus dem geprüften Fall'],
        workflow: [
            { number: '01', title: 'Anfrage empfangen', text: 'WhatsApp, Telefon, Theke oder E-Mail landet im richtigen Arbeitsvorrat.' },
            { number: '02', title: 'Kontext ergänzen', text: 'Kunde, Fahrzeug, Fahrzeugschein und Teilewunsch werden am Vorgang geführt.' },
            { number: '03', title: 'Fachlich prüfen', text: 'Offene Angaben und Varianten gehen sichtbar an einen Mitarbeiter.' },
            { number: '04', title: 'Weiterverkaufen', text: 'Aus dem geprüften Bedarf entstehen Angebot und Auftrag ohne Neuerfassung.' },
        ],
        capabilities: [
            { title: 'Eine Inbox für alle Eingänge', text: 'Kanalfilter, Zuständigkeit, Status und Eskalationen schaffen einen klaren Arbeitsvorrat.' },
            { title: 'Texte aus dem echten Dialog', text: 'Originalnachrichten bleiben sichtbar; Partsunion macht sie bearbeitbar, ohne den Kundenton umzuschreiben.' },
        ...
        controlTitle: 'Automatisierung stoppt dort, wo Fachwissen gefragt ist.', controlText: 'Unklare Varianten, Reklamationen und fehlende Angaben bekommen einen sichtbaren Prüfstatus. Kein stiller Klick entscheidet über das Teil.',
    ...
    },
    {
        ...
        title: 'Vom Fahrzeug zum passenden Teil – mit prüfbarer Datenbasis.',
        intro: 'Partsunion verbindet VIN, HSN/TSN und Fahrzeugschein mit lizenzierten Herstellerkatalogen, für die die erforderlichen Nutzungsrechte vorliegen. OE-Nummern, Alternativen, Preis und eigener Bestand bleiben in einer nachvollziehbaren Auswahl.',
        promise: 'Genaue OE-Ermittlung statt Teilenummern auf Verdacht.',
        without: ['Zwischen mehreren Katalogfenstern springen', 'OE-Nummern manuell übertragen', 'Unklare Ausführungen still auswählen', 'Preis und Bestand erst nach der Ermittlung suchen'],
        withPartsunion: ['Fahrzeug, Katalog und Artikeldaten verbunden', 'Offene Ausstattungsvarianten bleiben sichtbar', 'Alternativen und Vergleichsnummern nebeneinander', 'Preis, Marge und Bestand direkt im Kontext'],
        workflow: [
            { number: '01', title: 'Fahrzeug bestimmen', text: 'VIN, Fahrzeugschein oder HSN/TSN bilden den Startpunkt.' },
            { number: '02', title: 'Bauteil eingrenzen', text: 'Baugruppe und Kundenwunsch werden dem Fahrzeug zugeordnet.' },
            { number: '03', title: 'Kandidaten prüfen', text: 'OE, Alternativen und offene Varianten bleiben nachvollziehbar.' },
            { number: '04', title: 'Verfügbarkeit entscheiden', text: 'Eigener Bestand, Preis und freigegebene Quellen ergänzen die Fachentscheidung.' },
        ],
        capabilities: [
            { title: 'Fahrzeugdatenbank mit 56 Marken', text: 'Fahrzeugkontext für die anschließende Teile- und OE-Prüfung.' },
            ...
            { title: 'OE- und Vergleichsnummern', text: 'Herstellerreferenzen und passende Alternativen lassen sich gemeinsam betrachten.' },
            { title: 'Eigene Artikeldaten', text: 'Katalogergebnis trifft auf deinen Bestand, deine Preise und deine Sortimentslogik.' },
        ],
        controlTitle: 'Offene Variante bleibt offen.', controlText: 'Wenn Ausstattung oder Ausführung nicht eindeutig ist, zeigt Partsunion den Klärbedarf. Die finale Teileentscheidung bleibt prüfbar und fachlich verantwortet.',
