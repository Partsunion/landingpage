...
const views: ProductView[] = [
    ...
    },
    {
        ...
        description: 'Die Warenwirtschaft unterscheidet Neuware und Einzelstücke und verbindet OE, interne Artikelnummer, Lagerbestand, Einkauf, Verkauf und Marge.',
        image: '/product/artikel-bestand.png',
        width: 2400,
        height: 1500,
        icon: Boxes,
        facts: ['OE und interne Artikelnummer', 'Neuware und Einzelstücke', 'Bestand, EK, VK und Marge'],
    },
    {
        key: 'finanzen',
        label: 'Finanzen',
