...
const workAreas: Array<{ number: string; title: string; summary: string; icon: LucideIcon; items: string[]; href: string }> = [
    { number: '01', title: 'Verkauf', summary: 'Von der ersten Anfrage bis zur ausgeglichenen Rechnung.', icon: ShoppingCart, items: ['Anfragen & WhatsApp', 'Theke, Angebot & Auftrag', 'Kundenakte & Belegkette', 'Kasse, Zahlung & offene Posten'], href: '/loesungen/angebot-auftrag' },
