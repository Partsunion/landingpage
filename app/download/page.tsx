  ...
  return (
    <div className="mk dl-page"><div className="mk-wrap">
      ...
      <section className="dl-faq" aria-labelledby="download-help"><div><p className="mk-kicker">Gut zu wissen</p><h2 id="download-help">Fragen zum Download.</h2><p>Deine Frage ist noch offen?<br /><Link href="/contact" className="dl-text-link">Sprich mit uns <ArrowRight aria-hidden="true" /></Link></p></div><div className="dl-questions">
        ...
        <details><summary>Warum zeigt Windows eine Herausgeberwarnung?</summary><p>Die aktuelle Windows-Datei ist eine ausdrücklich gekennzeichnete Prüfversion. Die öffentliche Microsoft-Signierung folgt nach der laufenden Abnahme. Die Mac-Versionen sind bereits mit PartsUnion Developer ID signiert und von Apple notarisiert.</p></details>
        <details><summary>Wie bekomme ich Updates?</summary><p>Diese Prüfversion wird nicht automatisch verteilt. Nach der finalen Abnahme stellt Partsunion signierte Kundenversionen über den regulären Updatekanal bereit.</p></details>
        <details><summary>Mein Download startet nicht. Was kann ich tun?</summary><p>Prüfe deine Internetverbindung und lade die Seite neu. Bleibt der Download blockiert, kontaktiere uns und teile uns dein Betriebssystem sowie den Wortlaut der Fehlermeldung mit.</p></details>
      </div></section>
