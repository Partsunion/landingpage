...
export const metadata: Metadata = {
  ...
  description:
    'Informationen zur Verarbeitung personenbezogener Daten auf der Partsunion Website, zu Kontaktanfragen, Cookies, Analyse und Ihren Rechten.',
  alternates: { canonical: 'https://partsunion.de/legal/datenschutz' },
  openGraph: { url: 'https://partsunion.de/legal/datenschutz' },
};
  ...
  return (
    <div className="container mx-auto px-5 pt-32 pb-20 max-w-3xl">
      <div className="blog-content max-w-none">
        ...
        <p className="text-sm text-muted-foreground">Stand: September 2026</p>
        ...
        <p>
          ...
          benutzen, werden verschiedene personenbezogene Daten erhoben. Personenbezogene Daten sind
        ...
        <p>
          ...
          <Link href="/legal/impressum">Impressum</Link> genannte Anbieter. Die ladungsfähige
          Anschrift und die vertretungsberechtigten Personen sind dort aktuell aufgeführt.
        </p>
        <p>E-Mail: datenschutz@partsunion.de</p>
        <p>
        ...
        <p>
          ...
          technisch notwendigen Cookies zur technisch fehlerfreien und optimierten Bereitstellung
          ...
          Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG); die
          Einwilligung ist jederzeit widerrufbar.
        </p>

        <h3>Kontaktformular</h3>
        <p>
          Bei einer Anfrage übermitteln wir zusätzlich den Einstiegspfad und den Absendepfad
          innerhalb unserer Website, gegebenenfalls vorhandene Kampagnenangaben (UTM-Parameter) und
          die Domain einer verweisenden Website. Diese Angaben helfen uns, den Anlass und die
          Herkunft Ihrer Anfrage nachzuvollziehen. Sie werden während des Seitenbesuchs nur im
          Arbeitsspeicher vorgehalten und erst beim Absenden mit Ihrer Anfrage gespeichert. Hierfür
          verwenden wir keine Cookies oder dauerhafte Browserspeicherung; Werbe-Klickkennungen wie
          GCLID und vollständige Referrer-Adressen werden nicht in die Anfrage übernommen. Ein
          Beratungstermin wird mit seiner Zeitzone und der Einwilligung zur Terminbearbeitung
          gespeichert. Die Buchung wird mit Ihrem Kontakt im CRM und unserem internen Kalender
          verknüpft. Zur Terminabwicklung versenden wir eine Bestätigung mit Termindetails und
          Kalenderanhang sowie eine interne Benachrichtigung an unser Team.
        </p>
        <p>
        ...
        <p>
          ...
          Anfrage sowie der anschließenden Beratung und Vertragsanbahnung. Über das genannte
          CRM-System hinaus geben wir diese Daten nicht ohne Ihre Einwilligung an Dritte weiter.
        </p>
        <p>
          ...
          1 lit. a DSGVO) sofern diese abgefragt wurde; die Einwilligung ist jederzeit widerrufbar.
        </p>
        <p>
        ...
        <p>
          ...
          <em> Geist</em> und <em>Geist Mono</em>. Die Schriftdateien werden bereits beim Erstellen
        ...
        <p>
          ...
          <strong> keine Cookies</strong>, speichert <strong>keine IP-Adressen</strong> und erstellt{' '}
          <strong>keine geräteübergreifenden Profile</strong>. Es werden ausschließlich aggregierte,
          nicht-personenbezogene Nutzungsdaten erhoben (z. B. aufgerufene Seiten, Referrer,
          ungefähre Herkunftsregion auf Länderebene, Gerätetyp).
        </p>
        <p>
          Da Plausible keine Informationen im Endgerät speichert oder ausliest, ist hierfür keine
          Einwilligung nach § 25 Abs. 1 TDDDG erforderlich. Rechtsgrundlage für die Verarbeitung der
          aggregierten Daten ist unser berechtigtes Interesse an einer datenschutzfreundlichen
          Reichweitenmessung und der Verbesserung unseres Angebots (Art. 6 Abs. 1 lit. f DSGVO).
        ...
        <p>
          Im Falle einer erfolglosen Bewerbung werden die Daten des Bewerbers nach Ablauf einer
          Frist von 6 Monaten nach Bekanntgabe der Absageentscheidung gelöscht, sofern einer
          Löschung keine sonstigen berechtigten Interessen des Datenverantwortlichen entgegenstehen.
        </p>
      </div>
    </div>
  );
