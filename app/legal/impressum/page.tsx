...
export const metadata: Metadata = {
  title: 'Impressum',
  description:
    'Impressum und Anbieterkennzeichnung der PartsUnion UG (haftungsbeschränkt) mit Anschrift, Vertretungsberechtigten und Registerangaben.',
  alternates: { canonical: 'https://partsunion.de/legal/impressum' },
  openGraph: { url: 'https://partsunion.de/legal/impressum' },
};
    ...
    <div className="container mx-auto px-5 pt-32 pb-20 max-w-3xl">
      <div className="blog-content max-w-none">
        ...
        <p>
          ...
          Gesetzen verantwortlich. Eine allgemeine Verpflichtung, übermittelte oder gespeicherte
          fremde Informationen zu überwachen oder aktiv nach rechtswidrigen Tätigkeiten zu forschen,
          besteht nicht. Verpflichtungen zur Entfernung oder Sperrung der Nutzung von Informationen
