...
export const metadata: Metadata = {
  ...
  description:
    'Allgemeine Geschäftsbedingungen für die Nutzung der Partsunion Software und die vertraglichen Leistungen der PartsUnion UG (haftungsbeschränkt).',
  alternates: { canonical: 'https://partsunion.de/legal/agb' },
  openGraph: { url: 'https://partsunion.de/legal/agb' },
};

export default function AGBPage() {
  return (
    <div className="container mx-auto px-5 pt-32 pb-20 max-w-3xl">
      <div className="blog-content max-w-none">
        ...
        <p>
          ...
          zwischen dem in unserem <Link href="/legal/impressum">Impressum</Link> genannten Anbieter
          (nachfolgend „Anbieter“) und dem Kunden (nachfolgend „Kunde“) über die Nutzung der
          Software-as-a-Service-Lösung „Partsunion“ (nachfolgend „Software“ oder „Dienst“) in der
          zum Zeitpunkt des Vertragsschlusses gültigen Fassung.
        </p>
        <p>
          (2) Abweichende Bedingungen des Kunden werden nicht Vertragsbestandteil, es sei denn, der
          Anbieter stimmt ihrer Geltung ausdrücklich und schriftlich zu.
        </p>
        <p>
          (3) Diese AGB gelten sowohl gegenüber Verbrauchern als auch gegenüber Unternehmern, es sei
          denn, in der jeweiligen Klausel wird eine Differenzierung vorgenommen. Verbraucher im
          Sinne dieser AGB ist jede natürliche Person, die ein Rechtsgeschäft zu Zwecken abschließt,
          die überwiegend weder ihrer gewerblichen noch ihrer selbständigen beruflichen Tätigkeit
          zugerechnet werden können (§ 13 BGB). Unternehmer im Sinne dieser AGB ist jede natürliche
        ...
        <p>
          (2) Der genaue Leistungsumfang richtet sich nach dem individuell vereinbarten
          Leistungspaket und der jeweiligen Leistungsbeschreibung.
        </p>
        <p>
          (3) Der Anbieter ist berechtigt, die Software weiterzuentwickeln und zu verbessern.
          Wesentliche Einschränkungen des Funktionsumfangs werden dem Kunden mit einer Frist von 4
        ...
        <p>
          (2) Der Anbieter erbringt Support per E-Mail während der Geschäftszeiten (Montag bis
          Freitag, 9:00 – 18:00 Uhr, ausgenommen gesetzliche Feiertage in Nordrhein-Westfalen).
        </p>
        <p>
        ...
        <p>
          ...
          Abrechnungszeitraum. Die Zahlung ist innerhalb von 14 Tagen nach Rechnungsstellung fällig.
        </p>
        <p>
          (3) Bei Zahlungsverzug ist der Anbieter berechtigt, den Zugang zur Software nach Mahnung
          und Setzung einer angemessenen Nachfrist vorübergehend zu sperren. Die Pflicht zur Zahlung
          der vereinbarten Vergütung bleibt hiervon unberührt.
        </p>
        <p>
          (4) Der Anbieter ist berechtigt, die Preise mit einer Ankündigungsfrist von 4 Wochen zum
          Ende eines Abrechnungszeitraums zu ändern. Im Falle einer Preiserhöhung steht dem Kunden
          ein Sonderkündigungsrecht zu.
        </p>

        <h2>§ 7 Laufzeit und Kündigung</h2>
        <p>
          (1) Sofern nicht anders vereinbart, beträgt die Mindestvertragslaufzeit 12 Monate. Der
          Vertrag verlängert sich automatisch um jeweils den gleichen Zeitraum, wenn er nicht mit
          einer Frist von 3 Monaten zum Ende der jeweiligen Laufzeit gekündigt wird.
        </p>
        <p>
          (2) Bei monatlich kündbaren Verträgen beträgt die Kündigungsfrist 1 Monat zum Monatsende.
        </p>
        <p>
          (3) Das Recht zur außerordentlichen Kündigung aus wichtigem Grund bleibt unberührt. Ein
          wichtiger Grund für den Anbieter liegt insbesondere vor, wenn der Kunde trotz Mahnung mit
          der Zahlung von mindestens zwei Monatsbeträgen in Verzug ist.
        </p>
        ...
        <p>
          ...
          Zeitraum von 30 Tagen zum Export zur Verfügung. Nach Ablauf dieser Frist werden die Daten
        ...
        <p>
          (2) Soweit der Anbieter im Rahmen der Vertragserfüllung personenbezogene Daten im Auftrag
          des Kunden verarbeitet, schließen die Parteien einen Auftragsverarbeitungsvertrag nach
          Art. 28 DSGVO.
        </p>
        <p>
          (3) Der Anbieter trifft angemessene technische und organisatorische Maßnahmen zum Schutz
        ...
        <p>
          (4) Der Anbieter haftet nicht für die Richtigkeit der durch die KI generierten Ergebnisse.
          Die KI-gestützte Teileidentifikation, OEM-Zuordnung und Angebotserstellung erfolgen nach
          bestem technischen Stand, können jedoch keine 100%ige Korrektheit garantieren. Der Kunde
          ist verpflichtet, geschäftskritische Ergebnisse eigenverantwortlich zu überprüfen.
        </p>

        <h2>§ 10 Geistiges Eigentum</h2>
        <p>
          (1) Alle Rechte an der Software, einschließlich der zugrunde liegenden Algorithmen,
          KI-Modelle, des Quellcodes, der Dokumentation und aller Weiterentwicklungen, verbleiben
          beim Anbieter.
        </p>
        <p>
        ...
        <p>
          (3) Die vom Kunden eingegebenen Daten verbleiben im Eigentum des Kunden. Der Anbieter ist
          berechtigt, anonymisierte und aggregierte Daten zur Verbesserung der Software zu
          verwenden.
        </p>
        ...
        <p>
          ...
          vertraulichen Informationen der jeweils anderen Partei vertraulich zu behandeln und nicht
          an Dritte weiterzugeben, es sei denn, dies ist zur Vertragserfüllung erforderlich oder
        ...
        <p>
          ...
          Mitteilung, gelten die geänderten AGB als angenommen. Der Anbieter weist den Kunden in der
          Änderungsmitteilung auf diese Rechtsfolge hin.
        </p>
        ...
        <p>
          ...
          werden, so berührt dies die Wirksamkeit der übrigen Bestimmungen nicht. An die Stelle der
          unwirksamen Bestimmung tritt eine wirksame Bestimmung, die dem wirtschaftlichen Zweck der
